...
class OptimizeMode extends \Protobuf\Enum
{
    ...
    public static function SPEED()
    {
        ...
        return self::$SPEED = new \google\protobuf\FileOptions\OptimizeMode('SPEED', self::SPEED_VALUE);
    }
    ...
    public static function CODE_SIZE()
    {
        ...
        return self::$CODE_SIZE = new \google\protobuf\FileOptions\OptimizeMode('CODE_SIZE', self::CODE_SIZE_VALUE);
    }
    ...
    public static function LITE_RUNTIME()
    {
        ...
        return self::$LITE_RUNTIME = new \google\protobuf\FileOptions\OptimizeMode('LITE_RUNTIME', self::LITE_RUNTIME_VALUE);
    }
