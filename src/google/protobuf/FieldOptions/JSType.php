...
class JSType extends \Protobuf\Enum
{
    ...
    public static function JS_NORMAL()
    {
        ...
        return self::$JS_NORMAL = new \google\protobuf\FieldOptions\JSType('JS_NORMAL', self::JS_NORMAL_VALUE);
    }
    ...
    public static function JS_STRING()
    {
        ...
        return self::$JS_STRING = new \google\protobuf\FieldOptions\JSType('JS_STRING', self::JS_STRING_VALUE);
    }
    ...
    public static function JS_NUMBER()
    {
        ...
        return self::$JS_NUMBER = new \google\protobuf\FieldOptions\JSType('JS_NUMBER', self::JS_NUMBER_VALUE);
    }
